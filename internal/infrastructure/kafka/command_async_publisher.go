...
var _ command.ReceiptAsyncPublisher = (*CommandReceiptAsyncPublisher)(nil)
...
func NewCommandReceiptAsyncPublisher(
	...
	return &CommandReceiptAsyncPublisher{
...
func (p *CommandReceiptAsyncPublisher) Publish(ctx context.Context, receipt command.Receipt) error {
	if receipt == nil {
...
func (p *CommandReceiptAsyncPublisher) processPublishingResponse() {
...
func (p *CommandReceiptAsyncPublisher) Start() {
	// start publisher command loop
	p.wg.Add(1)
	go func() {
		defer p.wg.Done()
...
func (p *CommandReceiptAsyncPublisher) Close() {
