...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print()
        print("用法:")
        print("  python fix_swagger.py <文件路径> [--dry-run] [--backup]")
        print("  python fix_swagger.py <目录> --batch")
        print()
        print("示例:")
        print("  python fix_swagger.py docs.go")
        print("  python fix_swagger.py docs.go --dry-run")
        print("  python fix_swagger.py docs.go --backup")
        print("  python fix_swagger.py . --batch")
        sys.exit(1)
