...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/gochat_internal_shared_http.ApiResponse"
                        }
                    },
                    "500": {
                        "description": "服务器内部错误",
        ...
        "/friendship/request/{request_id}/agree": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/friendship/request/{request_id}/refuse": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/roomship/request/{request_id}/agree": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/roomship/request/{request_id}/refuse": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "gochat_internal_shared_http.ApiResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "$ref": "#/definitions/gochat_internal_shared_http.BusinessCode"
                },
                "data": {},
                "message": {
                    "type": "string"
        ...
        "gochat_internal_shared_http.BusinessCode": {
            "type": "integer",
            "enum": [
                200,
                500,
